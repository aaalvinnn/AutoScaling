...
class EnvConfig:
    ...
    def __init__(self):
        # id
        self.config_name = "config_twitter_largescale_requests15"
        # 随机数种子
        self.seed = 1037
        ...
        # 服务器节点配置
        self.node_nums = 10
        self.node_min_cpu_resource = 32   # CPU核数
        self.node_max_cpu_resource = 32
        self.node_min_memory_resource = 512  # 内存 GB
        self.node_max_memory_resource = 512
